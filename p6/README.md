# CS537 P6
> UW-Madison COMP SCI 537 (CS537) Operating System Project 6: HTTP Proxy Web Server (Concurrency).   
> Originally from University of California-Berkeley (UCB) (I know, right?). [See their writeup](https://inst.eecs.berkeley.edu/~cs162/su20/static/hw/hw3.pdf).  
> Final grade: 100/100.  
  
1. We deleted the serve_forever in the main function. Instead, created several connections separately in serve_forever and serve_request.  
